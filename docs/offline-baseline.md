...
Thirty-seven font components and twenty-seven dictionary packs now have
...
twenty-two dictionary packs enumerated in
`locks/source-inputs.v1.json`, for twenty-seven unresolved components in total.
