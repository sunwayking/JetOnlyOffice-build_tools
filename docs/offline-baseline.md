...
Thirty-seven font components and thirty-two dictionary packs now have
...
seventeen dictionary packs enumerated in
`locks/source-inputs.v1.json`, for twenty-two unresolved components in total.
