...
Thirty-three font components and twenty-two dictionary packs now have
...
twenty-seven dictionary packs enumerated in
`locks/source-inputs.v1.json`, for thirty-six unresolved components in total.
