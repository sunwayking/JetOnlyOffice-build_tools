...
Thirty-seven font components and thirty-nine dictionary packs now have
...
ten dictionary packs enumerated in
`locks/source-inputs.v1.json`, for fifteen unresolved components in total.
