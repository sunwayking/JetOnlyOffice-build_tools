# Upstream ONLYOFFICE Build Tools

This is the upstream documentation retained for provenance. Its floating
branch instructions are not JetOnlyOffice release entrypoints.
