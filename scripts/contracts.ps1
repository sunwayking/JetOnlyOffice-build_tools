...
param(
    ...
    [ValidateSet("source-lock", "source-license-audit", "source-lfs-audit", "toolchain-lock", "image-lock", "build-manifest", "artifact-manifest", "command-catalog", "corpus-manifest", "gate-result", "release-policy", "release-evidence", "gate-catalog")]
    [string]$Contract,
